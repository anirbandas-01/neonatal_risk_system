...
# # Load model
# model = tf.keras.models.load_model(r"C:\Users\Abhisek kundu\Downloads\newborn_health_lstm.h5", compile=False)
...
#     ]
#     return np.array(features).reshape(1, 21, 1)  # LSTM shape
...
#         # Map risk level to Healthy / At Risk
#         if idx == 0:  # Low risk
...
#         return jsonify({
#             "status": binary_status,           # NEW: Add the binary status
#             "risk_level": RISK_CLASSES[idx],
#             "confidence": float(np.max(pred[0]))
#         })
#     except Exception as e:
